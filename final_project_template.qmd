...
omim2 <- read.table("https://data.omim.org/downloads/E49QMjV2RgOEwkO6viPNOQ/mimTitles.txt", header = FALSE, fill =TRUE, sep = "\t")
colnames(omim2) <- c("Prefix", "MIM Number", "Preferred Title", "Symbols", "Notes")
head(omim2)

#OMIM Synopsis, genomic coordiantes, and inheritance
omim3 <- read.table("https://data.omim.org/downloads/E49QMjV2RgOEwkO6viPNOQ/genemap2.txt", header = FALSE, fill= TRUE, sep = "\t")
